    ...
    return (
        <section className="bg-g5 h-full pt-16 px-4 md:px-10 lg:px-16 pb-16">
            <div className="h-full grid grid-cols-3 grid-rows-4 md:grid-rows-3 gap-y-4 md:gap-y-4 lg:gap-y-8">
                ...
                <div className="col-span-1 col-start-3 self-center row-start-3 md:col-start-1 md:row-start-1">

                    <img src="/images/usb.png" alt="alt" className="w-full max-w-[325px] md:rotate-180" />
                </div>
            </div>
        </section >
    )
